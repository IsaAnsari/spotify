...
async function getSongs(folder = "songs/A. R. Rahman") {
    // folder = folder.replace(/^songs\//, ""); // normalize path
        ...
        for (const folder of data.artists) {
            try {
                ...
                cardContainer.innerHTML += `
                    <div data-folder="songs/${encodedFolder}" class="card">
                        <div class="play">
                        ...
                        <img src="songs/${encodedFolder}/cover.jpg" alt="cover">
                        <h2>${info.title}</h2>
...
main()// --- BASE PATH FIX for hosting ---
